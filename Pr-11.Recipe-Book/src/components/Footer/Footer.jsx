  ...
  return <footer className="footer">
    ...
    <Container>
      <Row>
       ...
       <Col lg='12'>
          <p className="footer__copyright">Rawcipes<i class="ri-copyright-line"></i>  {year}. All rights reserved. </p>
          <p className="footer__text mt-4">Rawcipes: Your virtual culinary companion. Explore diverse <button className="upload-btn" onClick={recipeUpload} element={<RecipeUploadForm />}>recipes</button>, from classic comfort foods to exotic delights. Elevate your cooking experience with step-by-step instructions and tantalizing flavors, all at your fingertips.</p>
