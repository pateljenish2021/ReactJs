                ...
                <div className="profile__actions" ref={profileActionRef} onClick={toggleProfileActions}>
                  {
                    currentUser ? <div className="d-flex align-items-center justify-content-center flex-column">
                      <span onClick={logout}><MdOutlineLogout />Logout</span>
                      </div> : 
                    <div className="d-flex justify-content-center flex-column">
                      <Link to='/signup' class="d-flex align-items-center ms-3"><FiUserPlus className="me-1"/>Signup</Link>
                      <div style={{borderBottom:"1px solid #0000003e"}}></div>
                      <Link to='/login' class="d-flex align-items-center" style={{marginLeft:"12px"}}><MdLogin className="me-1"/>Login</Link>
                    </div>
                  }
                </div>
