...
const Shop = () => {
  ...
  const [selectedType, setSelectedType] = useState(""); // Veg/Non-Veg filter
  ...
  const fetchProducts = async () => {
    ...
    try {
      ...
      // Extract unique categories from the "categories" array in the products
      ...
      setIsLoading(false); // Hide loader after fetching is complete
    }
  };
          ...
          <Row className="dffdd">
            {isLoading ? (
              <div className="fullload">
                <div className="loader"></div> {/* Loader during data fetch */}
              </div>
