...
const StyleThree = (props) => {
  const { image, rating, description, name, discountprice, price } =
    props;
      ...
      <div className="custom-container">
        ...
        <div class="row">
          <div class="card three-card">
            ...
            <div className="one-shopping-bag three-shopping-bag"> <img src={Bag} alt="cart" className="shopping-bag" /> </div>
