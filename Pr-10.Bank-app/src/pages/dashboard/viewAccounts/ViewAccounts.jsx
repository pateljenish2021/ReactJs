                              ...
                              <div className="modal-body p-1">
                                <div className="container">
                                  <div className="row mt-2">
                                    <div className="col">
                                      <button type="button" className="btn btn-sm btn-danger text-white" data-bs-dismiss="modal"><i className="fa-solid fa-arrow-left"></i> View All Accounts</button></div>
                                  </div>
                                  ...
                                  <div className="row ">
                                    <div className="col text-end">
                                      <button className=' btn btn-sm btn-success me-2' data-bs-toggle="modal" data-bs-target="#exampleModal2">
